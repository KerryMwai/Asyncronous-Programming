...
void main(List<String> args) async {
  await for(final name in getAllNames().absorbErrorsUsingHandleError()){
    print(name);
  }
  print("_____________________");
    await for(final name in getAllNames().absorbErrorsUsingHandlers()){
    print(name);
  }

  print("_____________________");

    await for(final name in getAllNames().absorbErrorsUsingTransformer()){
    print(name);
  }
}
